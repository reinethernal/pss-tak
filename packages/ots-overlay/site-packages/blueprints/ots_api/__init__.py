...
from opentakserver.blueprints.ots_api.search_sector_api import search_sector_api
from opentakserver.blueprints.ots_api.mission_ops_api import mission_ops_api
from opentakserver.blueprints.ots_api.track_api import track_api
...
from .client_apps_api import client_apps_api
from .psr_invite_api import psr_invite_api
from .psr_crm_api import psr_crm_api
from .psr_field_auth import register_field_auth

ots_api = Blueprint("ots_api", __name__)
ots_api.register_blueprint(api_blueprint)
ots_api.register_blueprint(client_apps_api)
ots_api.register_blueprint(psr_invite_api)
ots_api.register_blueprint(psr_crm_api)
...
ots_api.register_blueprint(search_sector_api)
ots_api.register_blueprint(mission_ops_api)
ots_api.register_blueprint(track_api)

# Field apps authenticate with mTLS client cert (CN = username) on :8443.
register_field_auth(search_sector_api)
register_field_auth(mission_ops_api)
register_field_auth(track_api)
