...
public class Preferences {
    ...
    public static final boolean STREAM_USE_TCP_DEFAULT = true;
    ...
    public static final boolean ATAK_SEND_COT_DEFAULT = true;
    ...
    public static final boolean ATAK_SERVER_SSL_DEFAULT = true;
