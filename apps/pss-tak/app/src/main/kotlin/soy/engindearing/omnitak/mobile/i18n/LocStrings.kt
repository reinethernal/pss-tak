...
internal object LocStrings {
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "settings.openIcu" to "Live stream",
        "settings.openIcu.desc" to "Phone camera on MediaMTX — HQ sees and hears the field",
        "tools.liveStream" to "Live stream",
        "tools.liveStream.desc" to "Camera on — HQ sees and hears",
        "stream.title" to "Live stream",
        "stream.start" to "Start stream",
        "stream.stop" to "Stop",
        "stream.password" to "OTS password",
        "stream.noServer" to "Connect to the TAK server first (HQ invite).",
        "stream.target" to "RTSP %s:8554/%s",
        "stream.live" to "LIVE %s kb/s  %s",
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "settings.openIcu" to "Включить трансляцию",
        "settings.openIcu.desc" to "Камера телефона на MediaMTX — штаб видит и слышит",
        "tools.liveStream" to "Трансляция",
        "tools.liveStream.desc" to "Камера в эфир — штаб видит и слышит",
        "stream.title" to "Трансляция",
        "stream.start" to "Начать трансляцию",
        "stream.stop" to "Стоп",
        "stream.password" to "Пароль OTS",
        "stream.noServer" to "Сначала подключитесь к серверу (ссылка штаба).",
        "stream.target" to "RTSP %s:8554/%s",
        "stream.live" to "ЭФИР %s кбит/с  %s",
