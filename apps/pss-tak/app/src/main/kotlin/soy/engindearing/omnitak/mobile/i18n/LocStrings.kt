...
internal object LocStrings {
    ...
    private val EN: Map<String, String> = mapOf(
        ...
        "settings.openIcu" to "Open video stream",
        "settings.openIcu.desc" to "Pass current server settings into ПСР Видео (or download it)",
    ...
    private val RU: Map<String, String> = mapOf(
        ...
        "settings.openIcu" to "Открыть стрим",
        "settings.openIcu.desc" to "Передаёт настройки текущего сервера в «ПСР Видео»",
